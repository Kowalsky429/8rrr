  ...
  return (
    <footer className="lg:text-left">
      <div className="max-w-[1400px] mx-auto">
        <div className="flex justify-center items-center lg:justify-between p-6 border-b-2 dark:border-light">
          <div className="mr-12">
        ...
        <div className="mx-6 py-10 lg:py-20 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="mb-6 lg:mb-8 dark:hover:text-light">
              ...
              <p className="dark:hover:text-light">
                <a href="#faq">Faq</a>
              </p>
            </div>
            <div>
      ...
      <div className="text-center p-4 bg-black bg-opacity-50 dark:bg-opacity-30 md:justify-start text-light">
        <p>
